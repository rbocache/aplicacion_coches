...
<?php
    ...
    $FormularioCeina->showInput(
        ...
        $id = "nombre",
        $name = "nombre",
        $placeholder = "Escribe el nombre del vendor",
        $label = "Nombre",
    ...
    $FormularioCeina->showInput(
        ...
        $id = "apellidos",
        $name = "apellidos",
        $placeholder = "Introduce los apellidos del vendedor",
        $label = "Apellidos",
        $validacion = $existeValidacion
    );
...
?>
    <button type="submit" class="submit">Guardar Vendedor</button>
</form>
</div>
<?php
...
if (!$errores && $existeValidacion) {
    ...
    $idDireccion = $enviarVendedor->enviarDireccion(
        'sssss',
